...
function problemA() {
  ...
  readfileAsync("poem-one/stanza-01.txt");
}
...
function problemC() {
  ...
  async function inOrder() {
    await readFileAsync("poem-one/stanza-02.txt");
    await readFileAsync("poem-one/stanza-03.txt");
    console.log("done");
  }
  inOrder();
}
...
function problemD() {
  ...
  readFileAsync("poem-one/wrong-file-name.txt");
}
...
function problemE() {
  ...
  async function inOrder() {
    try {
      await readFileAsync("poem-one/stanza-03.txt");
      await readFileAsync("poem-one/wrong-file-name.txt");
    } catch (e) {
      magenta(e);
    }
  }
